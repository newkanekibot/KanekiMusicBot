...
from config import BOT_USERNAME, BOT_NAME, ASSISTANT_NAME, GROUP_SUPPORT, OWNER_NAME, UPDATES_CHANNEL
...
/reload - Untuk Merefresh admin list
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "Group", url="https://t.me/TebBotSupport"
                    ),
                    InlineKeyboardButton(
                        "Kaneki", url="https://t.me/KanekiMusicbot"
                    )
                ]
            ]
        )
