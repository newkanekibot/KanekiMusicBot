...
@Client.on_message(command(["saavn", f"saavn@{bn}"]) & ~filters.edited)
...
@Client.on_message(command(["deezer", f"deezer@{bn}"]) & ~filters.edited)
...
@Client.on_message(command(["video", f"video@{bn}"]) & ~filters.edited)
